...
Link: https://jongryn.github.io/Bamazon/

You can find screenshots of the working Bamazon in: /public/assets/images
...
git clone git@github.com:jongryn/bamazon.git
cd bamazon
npm install
