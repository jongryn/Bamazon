/*
// Created: Sep. 7, 2017 11:00 PM
// Author: Jonathan Gryn
// Revisions: Jon (9/7/17) - Finished Manager JS
*/
...
// validateNumeric makes sure that hte user is supplying only positive numbers for their inputs
...
function createNewProduct() {
    ...
    // Prompt the user to enter the information about the new product
    inquirer.prompt([
        {
            type: 'input',
            name: 'product_name',
